...
Sensors.SensorDataModel {
    ...
    property int cpuCoreIgnoreCount: plasmoid.configuration.cpuCoreIgnoreCount
    ...
    function getValue() {
        let values = [];
        let coreCount = _coreCount - cpuCoreIgnoreCount;
        ...
        if (agregator === "average") {
            return values.reduce((a, b) => a + b, 0) / coreCount;
